...
const ProductItem = ({ item }: PropTypes) => {
    ...
    return (
        <>
            <div className="single-product rounded-md">
                ...
                <div className="px-8 py-5 bg-white shadow-sm">
                    ...
                    <div className="w-full flex flex-col gap-3 border-t border-gray-200 pt-[10px] text-center">
                        ...
                        <button onClick={handleBuy} className="flex gap-2 justify-center bg-gray-100 text-[#3749BB] px-4 py-2 rounded text-sm font-bold hover:bg-[#3749BB] hover:text-white">
            ...
            {
                open && <ByMessageModal setOpenModal={setOpen} item={ item} />
            }
        </>
    )
}
