...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className={`bg-white py-3 border-b border-gray-200 shadow-sm relative`}>
                <div className='max-w-[1290px] mx-auto px-4 flex'>
                    <nav className={`h-full fixed lg:static top-0 left-0 bg-white lg:bg-inherit w-[100%] sm:w-[50%] z-[9999] translate-x-[-100%] lg:translate-x-0 ${showNav && 'translate-x-[0]'} transition-all duration-300`}>
