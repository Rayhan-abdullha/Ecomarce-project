...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <svg onClick={handleNav} className="lg:hidden absolute top-[20px] left-5 text-white feather feather-menu cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>
            <div className={`bg-white py-3 border-b border-gray-200 shadow-sm relative ${(showNav && innerWidth <= 1024) ? 'block' : 'hidden'} lg:block`}>
                <div className='max-w-[1290px] mx-auto px-4 flex'>
                    <nav className={`h-full fixed lg:static top-0 left-0 bg-white lg:bg-inherit w-[50%] z-[999] translate-x-[-100%] lg:translate-x-0 ${showNav && 'translate-x-[0] transition-transform'}`}>
