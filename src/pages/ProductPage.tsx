        ...
        <>
            ...
            <div className="max-w-[1290px] mx-auto mt-5 px-4">
                <div className="flex gap-5">
                    <div className={`filter-by-components w-2/3 md:w-[40%] lg:w-[25%] fixed top-0 ${showFilter && innerWidth <= 1024 ? 'right-0 z-[999999]' : 'right-[-150%]'} lg:static bg-slate-100 z-[999] lg:z-0 h-full overflow-auto transition-right duration-300 ease-in-out`}>
